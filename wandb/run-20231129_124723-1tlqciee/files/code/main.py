...
opts = Options(
    ...
    patience = 300000,
    early_stopping_epoch = 2500,
    warmup_stopping_epoch = 50,
    warmup_epochs = 9,
    multiplier = 10000,
    cosine_epochs = 40, 
    max_grad_norm = 3.0,
...
def main():
    ...
    train_dl = data.DataLoader(dataloader.small_train, batch_size = opts.batch_size, shuffle=True)
