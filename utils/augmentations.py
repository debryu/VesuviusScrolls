...
train_aug_list = [
    ...
    #A.ShiftScaleRotate(rotate_limit=360,shift_limit=0.15,scale_limit=0.15,p=0.55),
    ...
    #A.CoarseDropout(max_holes=5, max_width=int(size * 0.2), max_height=int(size * 0.2), mask_fill_value=0, p=0.5),
